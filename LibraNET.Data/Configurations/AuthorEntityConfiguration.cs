		...
		public void Configure(EntityTypeBuilder<Author> builder)
		{
			builder.HasData(new Author[]
			{
				new Author
				{
					...
					ImageId = Guid.Parse("9922bd91-535d-47f1-b277-e905e1ba6c14")
				},
				new Author
				{
					...
					ImageId = Guid.Parse("c2afa02d-edba-439e-8179-c834cdbf63ff")
				},
				new Author
				{
					...
					ImageId = Guid.Parse("87af0318-95ab-43fb-a087-4488e97f98c7")
				},
				new Author
				{
					...
					ImageId = Guid.Parse("3dbf456f-a7ca-4a4f-aa56-149582aae280")
				},
				new Author
				{
					...
					ImageId = Guid.Parse("02b07984-b4ba-4fff-8b66-231e8b6a59f1")
				},
				new Author
				{
					...
					Name = "Matt Slays",
					Description = "Matt Slays and Rebecca Zamolo, the stars and creators of the mega-popular Game Master Network, are two of the most popular YouTubers in the world. With more than 30 million subscribers across their social media platforms, Matt and Rebecca have become popular stars with a highly engaged audience.",
					ImageId = Guid.Parse("b10bf8fa-87b9-4a05-abd1-10f3ce882d08")
				},
				new Author
				{
					...
					ImageId = Guid.Parse("70cf8640-398d-49a1-bce1-1cb6d8557cce")
				},
				new Author
				{
					...
					ImageId = Guid.Parse("52372469-66a6-4ef9-8988-97a5d97724cf")
				},
				new Author
				{
					...
					ImageId = Guid.Parse("5fc12440-02b2-486d-9e92-abc57885fd6b")
				},
				new Author
				{
					...
					ImageId = Guid.Parse("f9bccf28-07ba-472e-aeb8-e5859d30060c")
				},
				new Author
				{
					...
					ImageId = Guid.Parse("3a5625b9-a4eb-475e-bbc1-e759dcf8ea7d")
				},
                new Author
                {
					...
					ImageId = Guid.Parse("c8150876-a823-4f18-a8d0-626513d25c4d")
                },
                new Author
                {
					...
					ImageId = Guid.Parse("0cc23000-3de8-4321-a1fc-c5cc620aa9f1")
                },
                new Author
                {
					...
					ImageId = Guid.Parse("fc0494d9-d3da-433f-b0f1-3760d0ce00ca")
                },
                new Author
                {
					...
					ImageId = Guid.Parse("34773977-1191-4385-839e-33bc59a200e1")
                }
            });
		}
	}
